               ...
               <HeaderDeco />
                ...
                <section className="profile-section">
                    ...
                    <div>
                        ...
                        <i className="first-letter artist-font">L</i>amine Tayeb, dit " Elyes " né le 14/09/1951,artiste peintre, diplomé de I'ENBA a Alger ou it fait ses premieres etudes artistiques, s'oriente en communication visuelle it obtient son diplome en 1976 avec une annee de specialisation, jusqu'en 1977...<br/> 
                            admis sur dossier aux Beaux-arts option peinture 13 / 17, rue des Quais Malaquais Paris, ou it obtient le Diplome National Superieur Des Beaux-Arts en 1981, arrete pendant une duree de trois annees ou il s'adonne entierement a son art, puis entre a St Charles, fac des arts-plastiquesParis I Sorbonne pour enfin prendre conge des etudes avec une licence, et un projet en tete... 
